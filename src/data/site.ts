export const siteMeta = {
  ...
  heroLocation: "г. Москва (ЗАО, ЮЗАО)",
  heroText:
    "МКПП и АКПП, четыре программы обучения, спокойная и понятная подготовка внимательных водителей и сопровождение ученика от первой консультации до экзамена в ГИБДД.",
  priceFrom: "24 000 ₽",
  priceTo: "54 000 ₽",
  themeColor: "#14213F",
} as const;
